    ...
    <AnimatePresence>
      <div className="fixed inset-0 grid place-items-center z-100 p-4 md:p-8">
        ...
        <motion.button
          ...
          className="flex absolute top-6 right-6 items-center justify-center bg-surface-3 border border-border rounded-full h-12 w-12 z-110 hover:bg-surface-2 transition-all shadow-xl active:scale-90"
          onClick={onClose}
        >
          <CloseIcon />
        </motion.button>
              ...
              <div className="flex justify-between items-start gap-4 mb-4">
                <div className="space-y-1">
                  <motion.h3
                    ...
                    className="font-display font-bold text-foreground text-3xl lg:text-4xl tracking-tight leading-tight"
                  >
                    {project.title}
                  </motion.h3>
                  <motion.p
